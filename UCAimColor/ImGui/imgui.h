...
namespace ImGui
{
    ...
    IMGUI_API void          BeginFeaturesChild(const char* str_id, const ImVec2& size = ImVec2(0, 0));
    IMGUI_API bool          BeginChild(ImGuiID id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    IMGUI_API void          EndChild();
    IMGUI_API void          EndFeaturesChild();
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRadialGradient(const ImVec2& center, float radius, ImU32 col_in, ImU32 col_out);
